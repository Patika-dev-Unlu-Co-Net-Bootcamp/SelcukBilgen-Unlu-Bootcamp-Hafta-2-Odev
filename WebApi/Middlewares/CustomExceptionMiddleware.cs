...
namespace WebApi.Middlewares
{
    public class CustomExceptionMiddleware
    {
        ...
        {
            var watch = Stopwatch.StartNew(); // İzleme başlatma.
            try
            {
                //Requestlerin Console'a loglanması.
                string message = "[Request]  HTTP " + context.Request.Method + " - " + context.Request.Path;
                _loggerService.Write(message);
                await _next(context);
                watch.Stop(); // izlemeyi durdur.
    ...
    public static class CustomExceptionMiddlewareExtension  // Extension method
    {
